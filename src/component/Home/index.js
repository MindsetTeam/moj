          ...
          >
                     ...
                     return (
                        ...
                        >
                           <Link to={`/news-event/${v.id}`} className="row">
                              ...
                              <div
                                 className={
                                    "order-1 order-lg-2 carousel-img " +
                                    styles.carouselImg
                                 }
                                 style={{
              ...
              */}
                     {this.titleNews.map((v) => {
                        return (
                           <Link to={`/news-event/${v.id}`}>{v.title}</Link>
                        );
                     })}
                  </marquee>
               </div>
               ...
               >
                  <span
                     className={
                        ...
                        styles.carouselControlPrevIcon
                     }
                     aria-hidden="true"
                  ></span>
               ...
               >
                  <span
                     className={
                        ...
                        styles.carouselControlNextIcon
                     }
                     aria-hidden="true"
                  ></span>
               ...
               <div className={styles.leftSection}>
                  ...
                  <div className={"p-2 " + styles.ministerImgContainer}>
                     <div className={styles.ministerImg}>
                        <div
                           className={
                              "w-100 d-block text-center " +
                              styles.ministerImgTitle
                           }
                        >
                           <span>
                              ឯកឧត្តម កើត រិទ្ធ រដ្ឋមន្រ្ដីក្រសួងយុត្តិធម៌
                           </span>
                        </div>
                     </div>
                  </div>
                  ...
                  <div className={"mb-2 " + styles.activitiesContainer}>
                     <div
                        className={
                           "mb-1 p-1 px-2 pt-2 " +
                           styles.activitiesContainerTitle
                        }
                     >
               ...
               <div className={styles.rightSection}>
                  ...
                  <div className={styles.latestNewsContainer}>
                     <div
                        className={
                           "mb-1 p-1 px-2 pt-2 " +
                           styles.latestNewsContainerTitle
                        }
                     >
                        ព័ត៌មានថ្មីៗ
                     </div>
                     <div className={"row " + styles.latestNews}>
                        ...
                        >
                           ...
                           <p
                              className={
                                 "d-none d-lg-block " +
                                 styles.latestNewsInfoDescription
                              }
                           >
                              {truncateString(
                                 extractionHtml(
                           ...
                           <p className={styles.latestNewsInfoDate}>
                              {this.convertISODatetoKhmer(
                                 this.state.latestNews[0]?.date
                              )}
                           </p>
                        </div>
                        <div
                  ...
                  <div className={"my-2 " + styles.dailyNewsContainer}>
                     <div
                        className={
                           "mb-1 p-1 px-2 pt-2 " +
                           styles.dailyNewsContainerTitle
                        }
                     >
                        ព័ត៌មានប្រចាំថ្ងៃ
                        <span className="more">
                              ...
                              <React.Fragment>
                                 ...
                                 >
                                    ...
                                    <div
                                       className={
                                          "py-lg-1 pl-2 " +
                                          styles.eachDailyNewsInfo
                                       }
                                       style={{ width: "60%" }}
                                    >
                                       <h1
                                          className={
                                             styles.eachDailyNewsInfoTitle
                                          }
                                       >
                  ...
                  <div className={"mb-2 " + styles.annoucementsContainer}>
                     <div
                        className={
                           "mb-1 p-1 px-2 pt-2 " +
                           styles.annoucementsContainerTitle
                        }
                     >
                        សេចក្ដីជូនដំណឹង
                        <span className="more">
                     ...
                     <div className={"row px-3 " + styles.announcements}>
                        <div
                           className={
                              "col-md-6 col-12 py-4 " + styles.announcement
                           }
                        >
                           ...
                           <div className="ml-1">
                              <Link>
                                 សារថ្វាយព្រះពរ របស់ថ្នាក់ដឹកនាំ និងមន្ត្រី
                                 នៃសាលាឧទ្ធរណ៍
                        ...
                        >
                           ...
                           <div className="ml-1">
                              <Link>
                                 ...
                                 ក្រសួងយុត្តិធម៌ ជូនចំពោះ លោកជំទាវ សួស ណារ៉ា
                                 ហ៊ឹម ឆែម ព្រមទាំងក្រុមគ្រួសារ
                              </Link>
                           </div>
                        </div>
                        <hr className="w-100 m-0 d-none d-md-block" />
                        ...
                        >
                           ...
                           <div className="ml-1">
                              <Link>
                                 សេចក្តីប្រកាសព័ត៌មានរបស់អ្នកនាំពាក្យរបស់
                                 អយ្យការ អមសាលាដំបូងខេត្តស្វាយ រៀង
                                 បំភ្លឹអំពីការចុះផ្សាយរបស់ គេហទំព័រព័ត៌មាន...
                              </Link>
                           </div>
                        </div>
                        <div
               ...
               <div className="btm-section mb-3" style={{ clear: "both" }}>
                  ...
                  >
                     <div className="row m-0">
                        ...
                        <div
                           className={
                              "col-12 col-sm-6 p-0 " + styles.contactContainer
                           }
                        >
                           <div
                              className={
                           ...
                           <div className="contact p-2 pt-2">
                              <p className="m-0">
                                 លេខទូរស័ព្ទ : (+855) 23 216 322 , (+855) 23 217
                                 841{" "}
                              </p>
                              <p>
