...
export class ministryBiography extends Component {
   render() {
      return (
            ...
            <div className={"row m-0 " + styles.contentBody}>
               ...
               <div className="col-lg-5">
                  <p>
                     ...
                     Quibusdam fuga adipisci veniam, laborum dolorum ex itaque
                     tempore explicabo, impedit ab consectetur soluta ea tenetur
                     totam maxime distinctio cumque pariatur recusandae.
                  </p>
               </div>
...
export default ministryBiography;
